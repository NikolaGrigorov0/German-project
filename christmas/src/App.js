...
const App = () => {
  const dynamicParams = {
    ...
    fourthPage: {
      ...
      audioUrl: "/audio/der-weihnachtsbaum.mp3",
    ...
    fifthPage: {
      ...
      audioUrl: "/audio/der-lebkuchen.mp3",
    ...
    sixthPage: {
      ...
      audioUrl: "/audio/die-weihnachtsglocke.mp3",
    ...
    seventhPage: {
      ...
      audioUrl: "/audio/die-bescherung.mp3",
    ...
    eighthPage: {
      ...
      audioUrl: "/audio/der-wunschzettel.mp3",
    ...
    ninthPage: {
      ...
      audioUrl: "/audio/die-schneeflocke.mp3",
    ...
    tenthPage: {
      ...
      audioUrl: "/audio/der-rentier.mp3",
    ...
    eleventhPage: {
      ...
      audioUrl: "/audio/der-weihnachtsmann.mp3",
    ...
    twelfthPage: {
      ...
      audioUrl: "/audio/der-schlitten.mp3",
    ...
    thirteenthPage: {
      ...
      audioUrl: "/audio/die-zuckerstange.mp3",
    ...
    fourteenthPage: {
      ...
      audioUrl: "/audio/der-mistletoe.mp3",
    ...
    fifteenthPage: {
      ...
      audioUrl: "/audio/das-lebkuchenhaus.mp3",
    ...
    sixteenthPage: {
      ...
      audioUrl: "/audio/der-schneeball.mp3",
    ...
    seventeenthPage: {
      ...
      audioUrl: "/audio/das-schneien.mp3",
    ...
    eighteenthPage: {
      ...
      audioUrl: "/audio/die-verzierung.mp3",
    ...
    nineteenthPage: {
      ...
      audioUrl: "/audio/die-weihnachtsstern.mp3",
    ...
    twentyfirstPage: {
      ...
      audioUrl: "/audio/die-handschuhe.mp3",
    ...
    twentysecondPage: {
      ...
      audioUrl: "/audio/die-heisse-schokolade.mp3",
    ...
    twentythirdPage: {
      ...
      audioUrl: "/audio/die-weihnachtssocke.mp3",
    ...
    twentyfourthPage: {
      ...
      audioUrl: "/audio/die-heilige-nacht.mp3",
